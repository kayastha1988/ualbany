        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="header-login">
              ...
              <a class="login modal-form"  href="index.html">Logout</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.html">UAlbany Care Plus</a>              
         
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li><a href="addslots.php">Add Slots</a></li>
            <li class="active"><a href="mappointment.php">Manage Appointment</a></li>
